...
"""
功能模块20：雷达跟随
运行roslaunch simple_follower laser_fallower.launch
"""
...
def start_module():
    ...
    try:
        ...
        # 运行source命令
        subprocess.run("cd ~/agilex_ws && source devel/setup.bash", shell=True, executable="/bin/bash")
        
        # 启动雷达跟随
        cmd = "roslaunch simple_follower laser_follower.launch"
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("用法: python3 module20_lidar_following.py [start|stop]")
        sys.exit(1)
